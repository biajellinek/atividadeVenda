...
public class JwtServiceGenerator {  
	...
	public Map<String, Object> gerarPayload(Usuario usuario){
		...
		payloadData.put("nomeCompleto", usuario.getNomeCompleto());
		 ...
		 System.out.println("Payload gerado: " + payloadData);
	...
	public String extractNomeCompleto(String token) {
	    return extractClaim(token, claims -> claims.get("nomeCompleto", String.class));
	}
